							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12">
									<div class="block d-flex">
										<button type="button" src="map/getMap.jsp" class="btn btn-danger faqBtn btnMap" style="margin: auto;">지도추가</button>
										<button type="button" src="map/allMap.jsp" class="btn btn-danger faqBtn btnMap" style="margin: auto;">지도검색 및 삭제</button>
										<!-- 여유 있으면 box관리 추가 -->
