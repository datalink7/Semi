							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12">
									<div class="block d-flex">
										<button val="resv/resvMain.jsp" type="button" class="btn btn-danger btnResv" style="margin: auto;">보관함예약</button>
										<button val="resv/resvMain2.jsp" type="button" class="btn btn-danger btnResv" style="margin: auto;">반값예약</button>
										<button val="resv/resvMain3.jsp" type="button" class="btn btn-danger btnResv" style="margin: auto;">택배예약</button>
...
$(function() {
	$(".btnResv").click(function() {
		...
		if(src=="resv/resvMain2.jsp")
			$(".em").html("<embed src='"+src+"' width=100% height=800px>");
		else
			$(".em").html("<embed src='"+src+"' width=100% height=550px>");
...
<section class=" section">
	...
	<div class="container em">
			<embed src="resv/resvMain.jsp" width=100% height=600px>
	</div>
	<!-- Container End -->
</section>
