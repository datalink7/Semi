							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12">
									<div class="block d-flex">
										...
										<button type="button" class="btn btn-danger qnaBtn" style="margin: auto;">예약관련</button>
										<button type="button" class="btn btn-danger qnaBtn" style="margin: auto;">픽업관련</button>
										<button type="button" class="btn btn-danger qnaBtn" style="margin: auto;">택배보관관련</button>
										<button type="button" class="btn btn-danger qnaBtn" style="margin: auto;">결제관련</button>
										<button type="button" class="btn btn-danger qnaBtn" style="margin: auto;">회원가입/로그인관련</button>
									</div>
								</div>
							</div>
						</form>
					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td>
									<select class="form-control"  id="" name="" style="height: 40px; margin-top: 4px;">
										...
										<option value="">픽업관련</option>
										<option value="">택배보관관련</option>     
										<option value="">결제관련</option>
										<option value="">회원가입/로그인관련</option>
									</select>
								</td>
							</tr>
							<tr>
								<td style="width: 26%;">제목</td>
								<td><input type="text" class="form-control" id="" name="" style="height: 36px;"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="password" class="form-control" id="" name="" style="height: 36px;"></td>
							</tr>
						</tbody>
					</table>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-danger" style="width: 124px; height: 50px; margin-left: auto">문의등록</button>
				</div>
			</div>
		</div>
	</div>
